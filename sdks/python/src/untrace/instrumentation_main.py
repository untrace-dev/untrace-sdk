...
def instrument_openai(tracer: Any, metrics: Any, context: Any) -> None:
...
def instrument_anthropic(tracer: Any, metrics: Any, context: Any) -> None:
...
def instrument_google(tracer: Any, metrics: Any, context: Any) -> None:
...
def instrument_microsoft(tracer: Any, metrics: Any, context: Any) -> None:
...
def instrument_all(tracer: Any, metrics: Any, context: Any, providers: Optional[List[str]] = None) -> None:
...
def get_instrumented_providers() -> Set[str]:
