...
class OpenAIInstrumentation(BaseProviderInstrumentation):
    ...
    def instrument(self) -> None:
        ...
        try:
            ...
            OpenAI.__init__ = self._wrap_openai_constructor(OpenAI.__init__)  # type: ignore
            AsyncOpenAI.__init__ = self._wrap_async_openai_constructor(AsyncOpenAI.__init__)  # type: ignore
    ...
    def _wrap_openai_constructor(self, original_constructor: Callable) -> Callable:
    ...
    def _wrap_async_openai_constructor(self, original_constructor: Callable) -> Callable:
    ...
    def uninstrument(self) -> None:
        ...
        try:
            from openai import OpenAI, AsyncOpenAI
            OpenAI.__init__ = self._original_constructors['OpenAI']  # type: ignore
            AsyncOpenAI.__init__ = self._original_constructors['AsyncOpenAI']  # type: ignore
        except ImportError:
            pass
