...
class CohereInstrumentation(BaseProviderInstrumentation):
    ...
    def instrument(self) -> None:
        ...
        try:
            ...
            setattr(CohereClient, '__init__', self._wrap_cohere_constructor(CohereClient.__init__))
    ...
    def _wrap_cohere_constructor(self, original_constructor: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def _wrap_generate_sync(self, original_method: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def _wrap_chat_sync(self, original_method: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def _wrap_embed_sync(self, original_method: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def uninstrument(self) -> None:
        ...
        try:
            from cohere import Client as CohereClient
            setattr(CohereClient, '__init__', self._original_constructors['CohereClient'])
        except ImportError:
            pass
