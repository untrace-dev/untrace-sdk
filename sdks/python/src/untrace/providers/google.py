...
class GoogleInstrumentation(BaseProviderInstrumentation):
    ...
    def instrument(self) -> None:
        ...
        try:
            ...
            setattr(GenerativeModel, '__init__', self._wrap_generative_model_constructor(GenerativeModel.__init__))
    ...
    def _wrap_generative_model_constructor(self, original_constructor: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def _wrap_generate_content_sync(self, original_method: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def _wrap_start_chat_sync(self, original_method: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def uninstrument(self) -> None:
        ...
        try:
            from google.generativeai import GenerativeModel
            setattr(GenerativeModel, '__init__', self._original_constructors['GenerativeModel'])
        except ImportError:
            pass
