...
class MicrosoftInstrumentation(BaseProviderInstrumentation):
    ...
    def instrument(self) -> None:
        ...
        try:
            ...
            setattr(AzureOpenAI, '__init__', self._wrap_azure_openai_constructor(AzureOpenAI.__init__))
            setattr(AsyncAzureOpenAI, '__init__', self._wrap_async_azure_openai_constructor(AsyncAzureOpenAI.__init__))
    ...
    def _wrap_azure_openai_constructor(self, original_constructor: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def _wrap_async_azure_openai_constructor(self, original_constructor: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def uninstrument(self) -> None:
        ...
        try:
            from openai import AzureOpenAI, AsyncAzureOpenAI
            setattr(AzureOpenAI, '__init__', self._original_constructors['AzureOpenAI'])
            setattr(AsyncAzureOpenAI, '__init__', self._original_constructors['AsyncAzureOpenAI'])
        except ImportError:
            pass
