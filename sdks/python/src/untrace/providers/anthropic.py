...
class AnthropicInstrumentation(BaseProviderInstrumentation):
    ...
    def instrument(self) -> None:
        ...
        try:
            ...
            setattr(Anthropic, '__init__', self._wrap_anthropic_constructor(Anthropic.__init__))
            setattr(AsyncAnthropic, '__init__', self._wrap_async_anthropic_constructor(AsyncAnthropic.__init__))
    ...
    def _wrap_anthropic_constructor(self, original_constructor: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def _wrap_async_anthropic_constructor(self, original_constructor: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def _wrap_message_create_sync(self, original_method: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def _wrap_completion_create_sync(self, original_method: Callable[..., Any]) -> Callable[..., Any]:
    ...
    def uninstrument(self) -> None:
        ...
        try:
            from anthropic import Anthropic, AsyncAnthropic
            setattr(Anthropic, '__init__', self._original_constructors['Anthropic'])
            setattr(AsyncAnthropic, '__init__', self._original_constructors['AsyncAnthropic'])
        except ImportError:
            pass
